...
module.exports = function(proxy, allowedHost) {
  return {
    ...
    watchOptions: { ignored: ignoredFiles(paths.appSrc) }, // Enable HTTPS if the HTTPS environment variable is set to 'true'
    ...
    // Opens the browser when the dev server is running. Set it to true when it is required to open
    // a browser when the development server is started.
    open: false
  };
};
